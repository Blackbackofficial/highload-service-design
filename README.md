...
- Количество репозиториев `>330 million`(Возьмем, что из этого количества. На ноябрь 2018 в Github было создано 100m репозиториев. С учетом, что суммарно за период 2018-2020 годы количество репозиториев выросло еще на 100m (2019 - +40m; 2020 - +60m), возьмем, что в данный момент `количество репозиториев = 250+ миллионов`)
